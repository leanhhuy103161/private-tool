  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="mt-4 text-left shadow-lg bg-gray-100 p-12 w-96 rounded-2xl sm:w-loginForm">
        ...
        <h3 className="text-3xl mt-7 font-semibold">
          {t("auth.loginYourAccount")}
        </h3>
        <p className="pt-5 text-base">Login with email and password</p>
        <form>
          <div className="mt-4">
            <div>
            ...
            <div className="mt-5">
              ...
              <input
                ...
                className="w-full h-14 px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500"
              />
              {loginState.isLoginFail && (
            ...
            <div className="mt-5">
              <label className="inline-flex items-center">
                <input
                  type="checkbox"
                  className="w-6 h-6 text-orange-500 rounded-full focus:ring-0 border-0"
                  checked
                />
            ...
            <div className="mt-5 w-full flex flex-col items-baseline">
              ...
              <Link  className="text-lg font-semibold mx-auto mt-10 hover:underline" to="/register">Forgot password?</Link>
            </div>
          </div>
        </form>
      </div>
